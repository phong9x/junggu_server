...
-- Dumping data for table junggu.facility: ~11 rows (approximately)
...
INSERT INTO `facility` (`_id`, `NAME`, `DESCRIPTION`, `CREATE_DATE`, `UPDATE_DATE`) VALUES
	...
	(4, '약국', 'Pharmacy Restaurant', NULL, NULL),
	(5, '음식점', 's', NULL, NULL),
	(6, '이·미용실', 'The beauty salon', NULL, NULL),
	(7, '제과점(카페) ', 'Bakery ( Café )', NULL, NULL),
	(8, '판매상점', 'Sell ​​Stores', NULL, NULL),
	(9, '패스트푸드점', 'Fast food restaurants', NULL, NULL),
	(10, '화장실', 'restroom', NULL, NULL),
	(11, '기타 ', '기타', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `store` (
  ...
  `MONITORING_MAN_PHONE` varchar(255) NOT NULL,
...
INSERT INTO `store` (`_id`, `NAME`, `TAG`, `SERVICE_HOURS`, `HOLIDAY`, `BUILDING_FORM`, `FLOOR`, `FACILITY_LIST`, `REPRESENTATIVE`, `PHONE`, `ADDRESS`, `MONITORING_DATE`, `MONITORING_MAN`, `MONITORING_MAN_PHONE`, `FIELD_LIST`, `IMAGE_BASE_ATTACH`, `STORE_NAME`, `STORE_EXIT`, `STORE_ELEVATOR_POSITON`, `DISTANCE`, `BUILDING_STRUCTURE`, `PARKING_AREA`, `ENTRANCE_STATUS`, `LIVING_FACILITY`, `SPACE`, `PURPOSE_NOTE`, `ROOM_OF_REFECTOR`, `TOILETTE_FOR_DEFECTOR`, `MAIN_GOOD_SERVICE`, `STAFF_HELP_DEFECTOR`, `IMAGE_EXTEND_ATTACH`, `GRADE`, `ACCESSIBILITY_LIST`, `LONGITUDE`, `LATITUDE`, `IS_DELETE`, `CREATE_DATE`, `UPDATE_DATE`, `CAT_ID`, `USER_ID`) VALUES
	(12, 'TRAMS VIETNAME', '69693', '24', '65', '{"building_form":["1"]}', '5', '{"facility_list":["1","3","5","7","9","11"]}', 'representative', '01685899892', '10 Hang chao', '2015-11-10 02:59:00', '{"monitoring_man":["monitoring_man","monitoring_man","monitoring_man"]}', '{"monitoring_man_phone":["01685899892","01685899892","01685899892"]}', '{"field_list":[]}', '{"image_base_attach":[]}', 'asd', 'adsas', 'asdas', '{"distance":[{"main":[{"name":"도보로 10분 안에 접근 가능","value":"2","key":"2"}]}]}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{"image_extend_attach":[{"name_of_relevant":"null","photos":[]},{"name_of_relevant":"null","photos":[]}]}', '0', '{"accessibility_list":["1","2","3","4","5","6"]}', 'longitude', 'latitude', NULL, '2015-11-12 17:11:23', '2015-11-12 17:11:23', NULL, 66),
	(13, 'TRAMS VIETNAME', '69693', '24', '65', '{"building_form":["1"]}', '5', '{"facility_list":["1","3","5","7","9","11"]}', 'representative', '01685899892', '10 Hang chao', '2015-11-10 02:59:00', '{"monitoring_man":["monitoring_man","monitoring_man","monitoring_man"]}', '{"monitoring_man_phone":["01685899892","01685899892","01685899892"]}', '{"field_list":[]}', '{"image_base_attach":[]}', 'asd', 'adsas', 'asdas', '{"distance":[{"main":[{"name":"도보로 10분 안에 접근 가능","value":"2","key":"2"}]}]}', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '{"image_extend_attach":[{"name_of_relevant":"null","photos":[]},{"name_of_relevant":"null","photos":[]}]}', '0', '{"accessibility_list":["1","2","3","4","5","6"]}', 'longitude', 'latitude', NULL, '2015-11-12 17:16:05', '2015-11-12 17:16:05', NULL, 66),
	(14, 'TRAMS VIETNAME', 'coder,it,programer,game,dev', '24', '65', '{"building_form":["1"]}', '5', '{"facility_list":["1","3","5","7","9","11"]}', 'representative', '01685899892', '10 Hang chao', '2015-11-10 02:59:00', '{"monitoring_man":["monitoring_man","monitoring_man","monitoring_man"]}', '{"monitoring_man_phone":["01685899892","01685899892","01685899892"]}', '{"field_list":[]}', '{"image_base_attach":[]}', 'werew', 'rwer', 'wer', '{"distance":[{"main":[{"name":"도보로 10분 안에 접근 가능","value":"2","key":"2"}]}]}', '{"building_structure":[{"main":[{"name":"","value":"11","key":"1"},{"name":"","value":"12","key":"2"},{"name":"","value":"122","key":"3"}]}]}', NULL, NULL, NULL, NULL, '{"purpose_note":[{"main1":[{"name":"","value":"11","key":"1"},{"name":"","value":"22","key":"2"},{"name":"","value":"11","key":"1"},{"name":"","value":"22","key":"2"}]},{"main2":[{"name":"","value":"33","key":"1"},{"name":"","value":"44","key":"2"}]},{"main3":[]}]}', NULL, NULL, NULL, NULL, '{"image_extend_attach":[{"name_of_relevant":"null","photos":[]},{"name_of_relevant":"null","photos":[]}]}', '0', '{"accessibility_list":["1","2","3","4","5","6"]}', 'longitude', 'latitude', NULL, '2015-11-12 17:47:22', '2015-11-12 17:47:22', NULL, 66);
...
-- Dumping data for table junggu.user: ~6 rows (approximately)
DELETE FROM `user`;

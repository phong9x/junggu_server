...
public class FieldController extends AbstractController {
	...
	private static final String MAIN_ENTITY_NAME = "field";
	...
	private static String nav = "field";

	//--- JSP pages names ( View name in the MVC model )
	private static final String JSP_FORM   = "field/form";
	private static final String JSP_LIST   = "field/list";
	private static final String JSP_PAGING   = "field";
	private static final String JSP_DETAIL   = "field/detail";
	private static final String JSP_LOGIN   = "login";

	//--- SAVE ACTION ( in the HTML form )
	private static final String SAVE_ACTION_CREATE   = "/field/create";
	private static final String SAVE_ACTION_UPDATE   = "/field/update";
	...
	public FieldController() {
		super(FieldController.class, MAIN_ENTITY_NAME );
		log("FieldController created.");
	}
	...
	public String list(
		...
		Page<FieldEntity> listPage=fieldService.listPaging("%"+key+"%",page, PAGE_SIZE);
		model.addAttribute("activePage", nav);
		model.addAttribute("key", key);
		model.addAttribute("pagination_navigator", "/field/list");
		new Pager<FieldEntity>(listPage).setSetting(model, "key="+key+"&amp;");	
		return JSP_LIST;
	}

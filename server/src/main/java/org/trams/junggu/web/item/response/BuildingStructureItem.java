...
public class BuildingStructureItem  implements ResonseItem{
	...
	public String toJSONString() {
	    ...
	    try {
		    ...
		    responseDetailsJson.put("building_structure", jsonArray);
		} catch (Exception e) {
		}
	...
	public void parserJson(String json) {
		try {
			this.setMain(Utils.ConvertJsonTo_List_FormItem(json, "building_structure", "main"));
		} catch (Exception e) {
